...
func LoadAppConfig() AppConfig {
	...
	return AppConfig{
		...
		ConfigsDir:     env("RAYFLOW_CONFIGS_DIR", filepath.Join(dataDir, "configs")),
		LogsDir:        env("RAYFLOW_LOGS_DIR", filepath.Join(dataDir, "logs")),
		PresetsDir:     env("RAYFLOW_PRESETS_DIR", filepath.Join(dataDir, "presets")),
		AuthToken:      authToken,
